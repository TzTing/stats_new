...
public class StatisticsCenterServiceImpl implements StatisticsCenterService {
    ...
    private final StatisticsCenterManager statisticsCenterManager;
    ...
    public PageResult<Map<String, Object>> listTableDataForPage(StatisticsCenterQuery statisticsCenterQuery) {
        PageResult<Map<String, Object>> mapPageResult = statisticsCenterManager.listTableData(statisticsCenterQuery, true, PageResult.class);
    ...
    public List<FileList> listStatisticsTables(String typeCode, Integer years, Integer months) {
        List<FileList> fileLists = statisticsCenterManager.listStatisticsTables(typeCode, years, months);
        return fileLists;
    }


    @Override
    public void exportExcel(ExportExcelStatisticsCenterDTO exportExcelStatisticsCenterDTO, HttpServletResponse response) {
        Integer years = exportExcelStatisticsCenterDTO.getYears();
        Integer months = exportExcelStatisticsCenterDTO.getMonths();
        String distNo = exportExcelStatisticsCenterDTO.getDistNo();
        String userDistNo = exportExcelStatisticsCenterDTO.getUserDistNo();
        String tableName = exportExcelStatisticsCenterDTO.getTableName();
        String typeCode = exportExcelStatisticsCenterDTO.getTypeCode();
        Integer optType = exportExcelStatisticsCenterDTO.getOptType();
        List<String> distNos = exportExcelStatisticsCenterDTO.getDistNos();
        ...
        StatisticsCenterQuery statisticsCenterQuery = new StatisticsCenterQuery();
        statisticsCenterQuery.setUserDistNo(userDistNo);
        statisticsCenterQuery.setTypeCode(typeCode);
        statisticsCenterQuery.setTableName(tableName);
        statisticsCenterQuery.setYears(years);
        statisticsCenterQuery.setMonths(months);
        statisticsCenterQuery.setDistNo(distNo);
        statisticsCenterQuery.setPageNumber(0);
        statisticsCenterQuery.setPageSize(10000);
        statisticsCenterQuery.setDistNos(distNos);


        List<Map<String, Object>> list = statisticsCenterManager.listTableData(statisticsCenterQuery, false, null);
